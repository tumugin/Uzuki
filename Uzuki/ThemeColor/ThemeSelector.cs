...
namespace Uzuki.ThemeColor
{
    ...
    public class MkThemeSelector : DependencyObject
    {
        ...
        public static void AddThemeDictionary(DependencyObject obj, Uri value)
        {
            obj.SetValue(CurrentThemeDictionaryProperty, value);
        }

        public static void AddGlobalThemeDictonary(Uri value)
        {
            System.Windows.Application.Current.Resources.MergedDictionaries.Add(new ResourceDictionary() { Source = value});
        }
